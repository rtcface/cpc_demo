...
_ [cite_start]Marco Normativo Internacional [cite: 100]
_ [cite_start]Marco Normativo Nacional [cite: 108]
_ [cite_start]Marco Normativo Estatal [cite: 119]
_ [cite_start]Marco Normativo Interno [cite: 126]
...
_ [cite_start]Constitución Política del Estado de Tlaxcala [cite: 120]
_ [cite_start]Ley del Sistema Anticorrupción del Estado [cite: 121]
_ [cite_start]Ley de Transparencia del Estado [cite: 122]
_ (Y demás leyes del listado estatal) [cite_start][cite: 123-125]
...
_ [cite_start]Convención de las Naciones Unidas Contra la Corrupción [cite: 101]
_ [cite_start]Pacto Internacional de Derechos Civiles y Políticos [cite: 106] \* [cite_start]Reglamento Interno del CPC [cite: 127, 128]
...
_ [cite_start]Programa de Trabajo Anual [cite: 131]
_ [cite_start]Actividades (correspondientes a ese año) [cite: 132] \* [cite_start]Informes [cite: 133]
...
## Característica: Sección de Avisos de Privacidad

**Como** usuario del micrositio
**Quiero** acceder a los avisos de privacidad desde el menú principal
**Para** consultar y descargar los documentos oficiales de privacidad.

### Escenario: Visualización del menú de avisos de privacidad

**Dado** que el usuario accede a la barra de navegación principal
**Cuando** el sistema carga los elementos del menú
**Entonces** debe aparecer una nueva opción llamada "Avisos de Privacidad"
**Y** al hacer clic debe mostrar un grid con todos los avisos de privacidad disponibles.

### Escenario: Listado de avisos de privacidad en grid

**Dado** que el usuario selecciona "Avisos de Privacidad" en el menú
**Cuando** la página carga el contenido
**Entonces** debe mostrar un grid con tarjetas para cada aviso de privacidad:

- API Convocatorias y Concursos
- API Capacitativas e Informativas
- API Capacitaciones y Socializaciones
  **Y** cada tarjeta debe mostrar:
- Nombre del aviso
- Botón para descargar versión completa (PDF)
- Botón para descargar versión simplificada (PDF)
